        ...
        <div className="min-h-screen bg-neutral-950 text-white flex flex-col items-center justify-center p-6 font-sans relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-5xl w-full space-y-16 text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    {/* Card 1: Trabajo */}
                    <Link href="/onboarding/workspace" className="group relative p-8 rounded-2xl bg-[#1c1c21] border border-neutral-800 hover:border-blue-500 hover:bg-[#232329] transition-all duration-300 hover:-translate-y-2 flex flex-col items-center gap-5 cursor-pointer shadow-lg hover:shadow-blue-500/10">
                    ...
                    {/* Card 2: Uso Personal */}
                    <Link href="/onboarding/personal" className="group relative p-8 rounded-2xl bg-[#1c1c21] border border-neutral-800 hover:border-purple-500 hover:bg-[#232329] transition-all duration-300 hover:-translate-y-2 flex flex-col items-center gap-5 cursor-pointer shadow-lg hover:shadow-purple-500/10">
                        ...
                        <div className="space-y-2">
                            <h3 className="text-xl font-semibold text-white">Uso Personal</h3>
                    ...
                    {/* Card 3: Estudios */}
                    <Link href="/onboarding/estudios" className="group relative p-8 rounded-2xl bg-[#1c1c21] border border-neutral-800 hover:border-yellow-500 hover:bg-[#232329] transition-all duration-300 hover:-translate-y-2 flex flex-col items-center gap-5 cursor-pointer shadow-lg hover:shadow-yellow-500/10">
                        ...
                        <div className="space-y-2">
                            <h3 className="text-xl font-semibold text-white">Estudios</h3>
                            <p className="text-sm text-neutral-400 text-center leading-relaxed">Planifica entregas, cronogramas de exámenes y apuntes.</p>
                        </div>
                    </Link>

                    {/* Card 4: ONGs */}
                    <Link href="/onboarding/ong" className="group relative p-8 rounded-2xl bg-[#1c1c21] border border-neutral-800 hover:border-green-500 hover:bg-[#232329] transition-all duration-300 hover:-translate-y-2 flex flex-col items-center gap-5 cursor-pointer shadow-lg hover:shadow-green-500/10">
                        ...
                        <div className="space-y-2">
                            <h3 className="text-xl font-semibold text-white">ONGs</h3>
