import Link from 'next/link'; // Asegúrate de agregar este import arriba del todo del archivo
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-center min-h-screen gap-16">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left space-y-8 pt-20 lg:pt-0">
          ...
          <div className="w-full max-w-sm space-y-4 pt-4">
            <Link href="/onboarding" className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 transition-all duration-200 shadow-[0_0_20px_rgba(37,99,235,0.3)]">
