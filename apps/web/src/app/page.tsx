export default function Home() {
    return (
        <div className="flex min-h-screen bg-neutral-950 text-neutral-50 selection:bg-blue-600 selection:text-white">
            ...
            {/* PANEL IZQUIERDO: Branding Asimétrico y Textura Oscura (Inspiración Onyx) */}
            <div className="hidden lg:flex w-1/2 flex-col justify-between p-12 relative overflow-hidden bg-[#0a0a0a] border-r border-neutral-800">
                {/* Luces volumétricas sutiles para efecto premium */}
            ...
            <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-8 lg:p-24 relative bg-neutral-950">
                <div className="w-full max-w-sm space-y-10">
                    ...
                    {/* Área de Acciones Táctiles */}
                    <div className="space-y-6 pt-4">

                        {/* Botón de Google Estilo Premium */}
                        <button className="w-full flex items-center justify-center gap-3 px-4 py-3.5 bg-white text-neutral-950 font-medium rounded-xl hover:bg-neutral-200 transition-all duration-200 active:scale-[0.98] shadow-[0_0_20px_rgba(255,255,255,0.05)] border border-transparent hover:border-neutral-300">
                        ...
                        <div className="text-center">
                            <p className="text-neutral-400">
                                ...
                                <a href="#" className="text-blue-500 font-medium hover:text-blue-400 hover:underline transition-colors underline-offset-4">
                                    Iniciar sesión
                                </a>
                            </p>
                        </div>
                ...
                <div className="absolute bottom-8 text-center w-full text-xs text-neutral-600">
                    Al avanzar, aceptas las Condiciones del servicio y la Política de privacidad.
                </div>
            </div>
